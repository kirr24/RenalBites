...
class _EditRecipeScreenState extends State<EditRecipeScreen> {
  ...
  void initState() {
    ...
    recipeNameController.text = widget.recipe['recipeName']?.toString() ?? '';
    ...
    if (ingredients.isEmpty) {
      ...
      for (final item in ingredients) {
        ingredientControllers.add(TextEditingController(text: item.toString()));
      }
    }
    ...
    if (directions.isEmpty) {
      ...
      for (final item in directions) {
        directionControllers.add(TextEditingController(text: item.toString()));
      }
    }
  }
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: isSaving ? null : updateRecipe,
